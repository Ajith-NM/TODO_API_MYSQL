...
export const InsertUser = async (name, password, email, url, otp) => {
    return new Promise((resolve, reject) => {
        Users.create({ name: name, email: email, password: password, profilePic: url, otp: otp }).then((data) => {
...
export const UpdateOTP = async (email, otp) => {
    ...
    return new Promise((resolve, reject) => {
        Users.update({ otp: otp }, { where: { email: email } }).then((data) => {
...
export const UpdatePassword = async (email, password) => {
    ...
    return new Promise((resolve, reject) => {
        Users.update({ password:password }, { where: { email: email } }).then((data) => {
            console.log("upadted data=", data);
