...
import { CheckUser, GeneratePassword, InsertUser, SendMail, UpdateOTP, UpdatePassword } from "../services/userService.js";
...
export const emailValidation = async (req, res) => {
    ...
    try {
        ...
        const originalOTP = await CheckUser(req.cookies.email).then((data) => {
